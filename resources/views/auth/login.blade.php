    ...
    <div class="materialContainer">
        <div class="box">
            <form method="POST" action="{{route('login')}}">
                ...
                <a href="javascript:void(0)" class="pass-forgot">Hai dimenticato la password?</a>
                ...
                <p>Non sei un membro? <a href="{{route('register')}}" class="theme-color">Registrati ora</a></p>
            </form>
        </div>
    </div>
</div>
