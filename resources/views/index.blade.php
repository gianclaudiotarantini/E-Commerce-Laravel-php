...
<section class="pt-0 poster-section">
    ...
    <div class="left-side-contain">
        <div class="banner-left">
            <h4>Sconti <span class="theme-color">Fino al 35%</span></h4>
            <h1>Nuovi arrivi<span>Abbigliamento</span></h1>
            <p>COMPRA 1 <span class="theme-color">PRENDI 2</span></p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="collection-banner p-bottom p-center text-center">
                    ...
                    <div class="banner-detail">
                        ...
                        <span class="font-dark-30">26% <span>DI SCONTO</span></span>
                    </div>
                    <a href="shop-left-sidebar.html" class="contain-banner">
                        <div class="banner-content with-big">
                            <h2 class="mb-2">Nuova felpa col cappuccio</h2>
                            <span>PAGHI UNO PRENDI DUE</span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="collection-banner p-bottom p-center text-center">
                    ...
                    <div class="banner-detail">
                        ...
                        <span class="font-dark-30">50% <span>DI SCONTO</span></span>
                    </div>
                    <a href="shop-left-sidebar.html" class="contain-banner">
                        <div class="banner-content with-big">
                            <h2 class="mb-2">Donna con Stile</h2>
                            <span>Nuove offerte al 50%</span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="collection-banner p-bottom p-center text-center">
                    ...
                    <div class="banner-detail">
                        ...
                        <span class="font-dark-30">36% <span>DI SCONTO</span></span>
                    </div>
                    <a href="shop-left-sidebar.html" class="contain-banner">
                        <div class="banner-content with-big">
                            <h2 class="mb-2">nuove Giacche</h2>
                            <span>COMPRA UNO PRENDI DUE</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="row m-0">
            <div class="col-12 p-0">
                <div class="title-3 text-center">
                    <h2>Nuovi arrivi</h2>
                    <h5 class="theme-color">La nostra Collezione</h5>
                </div>
            </div>
        </div>
        <style>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title title-2 text-center">
                    <h2>Categorie</h2>
                    <h5 class="text-color">Le nostre Collezioni</h5>
                </div>
            </div>
        </div>
        <div class="row gy-3">
            <div class="col-xxl-2 col-lg-3">
                <div class="category-wrap category-padding category-block theme-bg-color">
                    <div>
                        ...
                        <h2 class="top-spacing">Scorri</h2>
                        <span>Categorie</span>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                            ...
                            <div class="category-content category-text-1">
                                <h3 class="theme-color">Calzature</h3>
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                            <img src="assets/images/fashion/category/4.jpg" class="bg-img blur-up lazyload"
                                alt="category image">
                            <div class="category-content category-text-1">
                                <h3 class="theme-color">Giacche</h3>
                                <span class="text-dark">Fashion</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row g-3">
                <div class="col-lg-4">
                    <div class="title-3 pb-4 title-border">
                        ...
                        <h5 class="theme-color">Le nostre Collezioni</h5>
                    </div>
...
<section class="ratio_asos overflow-hidden pb-5">
    <div class="px-0 container-fluid p-sm-0">
        <div class="row m-0">
            <div class="col-12 p-0">
                <div class="title-3 text-center">
                    <h2>Le migliori offerte di moda</h2>
                    <h5 class="theme-color">Le nostre Collezioni</h5>
                </div>
            </div>
                ...
                <div>
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="label-block">
                                <span class="label label-theme">30% di sconto</span>
                            </div>
                            <div class="cart-wrap">
                                <ul>
                                    <li>
