                                            ...
                                            <ul>
                                                @if (Route::has('login'))
                                                    @auth
                                                        ...
                                                        @else
                                                            <li>
                                                                <a href="{{ route('user.index') }}" class="d-block">Mio
                                                                    Account</a>
                                                            </li>
                                                        @endif
                                                        <li>
                                                    ...
                                                    @else
                                                        <li>
                                                            <a href="{{ route('login') }}" class="d-block">Accesso</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('register') }}"
                                                                class="d-block">Registrazione</a>
                                                        </li>
                                                    @endauth
                                                @endif
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>Telefono:</b> <span class="font-light"> +1 0000000000</span></span>
                                </li>
                                <li>
                                    <span><b>Indirizzo:</b><span class="font-light"> Roma, Italia
                                            </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> Contatti@support.it</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="contact-us.html" class="font-dark">Contatti</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="#" class="font-dark">I tuoi Ordini</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Il tuo Account</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Traccia gli ordini</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">La tua lista dei desideri</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Domande frequenti sugli acquisti</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 d-none d-sm-block">
                        <div class="footer-newsletter">
                            ...
                            <div class="form-newsletter">
                                ...
                                <p class="font-dark mb-0">Tieniti aggiornato con le nostre ultime novità e offerte speciali.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Gianclaudio.</p>
                    </div>
                </div>
            </div>
        </div>
